...
//
#include "LostDark/SH/Public/LDAIController.h" // UBehaviorTreeComponent & OwnerComp 에서 OwnerComp의 컴포넌트 기능을 사용하려면 필요
#include "LostDark/SH/Public/LostDarkCharacter.h" // 탐지한 폰이 우리 플레이어인지 추려낼때 필요함 (ALostDarkCharacter* AnyCharacter~~)
